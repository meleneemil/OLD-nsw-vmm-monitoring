...
#include "../monitoring/filereader.h"
...
QT_MOC_LITERAL(1, 11, 7), // "newLine"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 8) // "drawLine"

    },
    "fileReader\0newLine\0\0drawLine"
};
...
void fileReader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&fileReader::newLine)) {
                *result = 0;
            }
        }
        {
            typedef void (fileReader::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&fileReader::drawLine)) {
                *result = 1;
            }
        }
    }
