...
CDetReadout::CDetReadout(DetBaseWeakPtr detector,
    ...
    m_readout_charge_statistics_histo(new TH1D( std::string("Charge_"+ getMyChamberName()+name() ).c_str(),
                                                ...
                                                400,0,2000) ),
    m_readout_PDO_statistics_histo(new TH1D( std::string("BCID "+ getMyChamberName()+name() ).c_str(),
                                                std::string("BCID_"+ getMyChamberName()+name() ).c_str(),
                                                400,0,2000) ),
    m_readout_TDO_statistics_histo(new TH1D( std::string("extra "+ getMyChamberName()+name() ).c_str(),
                                                std::string("extra_"+ getMyChamberName()+name() ).c_str(),
                                                400,0,2000) ),
